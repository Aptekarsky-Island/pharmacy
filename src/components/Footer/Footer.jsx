      ...
      <div className="footer__container">
        ...
        <div className="footer__inner">
          <div className="footer__info">
            ...
            <p className="footer__hours">Мы открыта <b>10:00–21:00</b></p>
          </div>
          ...
          <div className="footer__group">
            ...
            <div className="footer__col footer__col_company">
              <h3>О компании</h3>
              <ul>
                <li><Link to="/catalog">Лицензии</Link></li>
                <li><a href="#">Вакансии</a></li>
              </ul>
            </div>
          </div>

          <div className="footer__col footer__col__clients">
            <h3>Клиентам</h3>
            <ul>
